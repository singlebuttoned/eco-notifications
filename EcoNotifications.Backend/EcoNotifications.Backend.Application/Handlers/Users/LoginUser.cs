...
public record LoginUser(UserLoginRequest LoginRequest) : IRequest<UserResponse>;

public class LoginUserHandler : IRequestHandler<LoginUser, UserResponse>
{
    ...
    public async Task<UserResponse> Handle(LoginUser request, CancellationToken cancellationToken)
    {
